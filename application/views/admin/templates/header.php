...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo $baseUrl; ?>" class="logo">
      ...
      <span class="logo-mini"><b>P</b>UK</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Admin</b> Pessuk</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $baseUrl; ?>assets/frontend/images/logo.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Pessuk-Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo $baseUrl; ?>assets/frontend/images/logo.png" class="img-circle" alt="User Image">
