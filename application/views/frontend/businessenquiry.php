...
<div class="row">
    <div class="col-sm-6">
    <img src="<?php echo $baseUrl;?>assets/frontend/images/parking/be.jpg"/>
    <h3><b>Fill in the text or alternatively, send us an email on info@pessuk.com or Contact Us on 020 8751 1676</b></h3>
    </div>
...
<div class="contact col-sm-6">
    ...
    <?php } ?>
<form method="post" action="<?php echo $baseUrl;?>parking_enforcement/benqiry_contact">
<div class="row">
     <div class="col-sm-12">
